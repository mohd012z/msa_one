...
function setShape(k){localStorage.setItem('msaButtonShape',S[k]?k:'soft');refresh()}function setEffect(k){localStorage.setItem('msaButtonEffect',E[k]?k:'gradient');refresh()}function setIntensity(v){localStorage.setItem('msaButtonIntensity',String(v));refresh()}
