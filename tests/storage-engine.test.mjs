...
for(const key of ['msaOneProjectsV1','msaOneProjectsBackupV1','msaOneProjectsLastGoodV1','msaPdfReadinessV1','msaOnePlannerV1','msaOneProfileV1','msaHelperV1','msaPerformanceV1','msaLibraryStateV2','msaUserLibraryV1','msaCompanionStateV1']) assert.ok(js.includes(key),'missing mirrored key '+key);
