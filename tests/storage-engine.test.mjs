...
for(const key of ['msaOneProjectsV1','msaOnePlannerV1','msaOneProfileV1','msaHelperV1','msaPerformanceV1','msaLibraryStateV2','msaUserLibraryV1']) assert.ok(js.includes(key),'missing mirrored key '+key);
