...
for(const asset of ['theme-v2.css','create-studio.css','files-workspace.css','planner.css','library.css','core-library.js','storage-engine.js','office-engine.js','import-engine.js','formula-engine.js','settings-v2.js','create-studio.js','files-workspace.js','planner.js','app-actions.js','library-engine.js']){
