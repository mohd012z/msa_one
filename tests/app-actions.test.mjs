...
for(const asset of ['theme-v2.css','create-studio.css','files-workspace.css','planner.css','library.css','helper.css','performance.css','app-manifest.js','core-library.js','performance-engine.js','storage-engine.js','office-engine.js','import-engine.js','formula-engine.js','settings-v2.js','create-studio.js','files-workspace.js','planner.js','app-actions.js','library-engine.js','library-updater.js','helper-engine.js']){
