...
for(const asset of ['theme-v2.css','create-studio.css','files-workspace.css','planner.css','storage-engine.js','office-engine.js','settings-v2.js','create-studio.js','files-workspace.js','planner.js','app-actions.js']){
