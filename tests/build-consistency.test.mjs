...
assert.equal(pkg.version,'40.0.0','package version must match MSA One 40');
...
assert.equal(cap.appName,'MSA One 40','Capacitor app name must match build');
...
console.log('MSA One 40 build consistency contract passed');
